...
/**
 VZParsedStruct will represent a struct parsed by the struct parser. It will hold all types that
 the struct has within itself, including nested structs.
 */
@interface VZParsedStruct : VZParsedType
 ...
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<VZParsedType *> *typesContainedInStruct;

- (nonnull instancetype)initWithName:(nullable NSString *)name
                        typeEncoding:(nonnull NSString *)typeEncoding
                      structTypeName:(nullable NSString *)structTypeName
              typesContainedInStruct:(nonnull NSArray<VZParsedType *> *)typesContainedInStruct;
 ...
 */
- (nonnull NSArray<VZParsedType *> *)flattenTypes;
