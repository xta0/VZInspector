...
#include "VZAllocationTrackerNSZombieSupport.h"

bool vz_isZombieObject(_Nullable id object) {
  if (object == nil) { return true; }
  if (!vz_isNSZombieEnabled()) { return false; }
...
bool vz_isNSZombieEnabled(void) {
