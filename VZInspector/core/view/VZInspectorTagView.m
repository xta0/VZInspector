...
@implementation VZInspectorTagView{
    BOOL _hasCalculateSize;
    CGSize _textCalculateSize;
}
...
- (CGSize) intrinsicContentSize {
    ...
    if(_hasCalculateSize){
        return _textCalculateSize;
    }
    ...
    _hasCalculateSize = YES;
    _textCalculateSize = size;
    return size;
}
