...
@implementation VZCPUInspector

+ (instancetype)sharedInstance {
    static VZCPUInspector *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [VZCPUInspector new];
    });
...
- (void)vz_heartBeat
{
    ...
    [self.samplePoints addObject:[NSNumber numberWithUnsignedLongLong:[[self class] cpuUsage]]];
